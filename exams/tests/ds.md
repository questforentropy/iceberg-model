...
| ID | Row | Verifies |
|---|---|---|
| DS-1 | D1 | the counting layer: a regular lattice's boosted chain is stuck at e^(−η) at EVERY resolution — fineness fixes nothing |
| DS-2 | D2 | the dynamics layer: bending converges with grid refinement — fineness is all dynamics needs |
| DS-3 | DS3 | the last tell: statistical travel-time blur fades with fineness (~density^−0.64) — any finite observational precision can be out-run by a finer sprinkle |
